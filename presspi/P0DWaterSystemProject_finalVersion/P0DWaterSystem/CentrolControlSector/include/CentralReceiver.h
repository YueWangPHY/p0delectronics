...
class CentralReceiver//: public ActionBase
{
public:
	CentralReceiver(asio::io_service& io_service, const short portNoR): socket_(io_service, asio::ip::udp::endpoint(asio::ip::udp::v4(),portNoR))
    {
...
//		}
        socket_.async_receive_from(asio::buffer(data_,max_len), sender_endpoint_,
                                    bind(&CentralReceiver::handle_receive_from, this, std::placeholders::_1, std::placeholders::_2));
