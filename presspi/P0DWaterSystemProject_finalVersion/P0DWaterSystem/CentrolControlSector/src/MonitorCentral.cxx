...
//	std::cout<<"Program will come back and check the depth after some time"<<std::endl;
...
int main(int argc, char* argv[])
{
    ...
    std::shared_ptr<CentralAction> pAction(new CentralAction(ps, pr, 0, filepath, fillupto));//to monitor set 0
