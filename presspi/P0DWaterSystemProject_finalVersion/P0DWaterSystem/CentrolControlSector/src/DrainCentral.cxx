...
int main(int argc, char* argv[])
{
	...
	int draintill = 1800;//mm in default
	if(argc>1)
		sscanf(argv[1], "%d", &draintill);
    ...
    std::shared_ptr<CentralAction> pAction(new CentralAction(ps, pr, 3, filepath, draintill));//to drain set 3 
