...
int main(std::string filepath)
{
	...
	while(true)
	{
		filefd = open(filepath, O_RDWR);//("/home/pi/P0DWaterSytemProject/P0DWaterSytem/CentrolControlSector/src/generatedDepth.txt", O_RDWR);
...
*/	
		...
		for(int i=0;i<50;i++)//num
		{
			...
			ReadDepthTemp(psBoar, psChannel, Nmeasure, avePress, aveTemp);
